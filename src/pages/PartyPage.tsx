            ...
            <div className="grid lg:grid-cols-5 gap-16 items-start mb-32">
              <div className="lg:col-span-3 space-y-8">
                ...
                <div className="space-y-6 text-lg text-gray-600 leading-relaxed font-light">
                  ...
                  <p>
                    Von Charts über Classics bis zu speziellen Wünschen – mein Repertoire ist so vielseitig wie Ihre Gäste. Hauptsache: Die Tanzfläche ist voll und die Stimmung ist perfekt.
                  </p>
                  <p>
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-gray-900 to-gray-800 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative">
            <h2 className="text-3xl md:text-4xl font-semibold text-white/60 mb-6">
              Unsicher, ob ein DJ zu Ihrer Party passt?
            </h2>

            <div className="space-y-8 mb-12">
              <p className="text-2xl md:text-3xl lg:text-4xl text-white font-light leading-relaxed">
                Ihre Party verdient <strong className="font-semibold" style={{ color: accentColorLight }}>keinen Show-DJ</strong>, sondern Musik, die im richtigen Moment das Richtige tut.
              </p>

              <p className="text-xl md:text-2xl text-white/90 leading-relaxed max-w-3xl mx-auto font-light">
                Ich arbeite ohne starre Playlists und passe mich Ihnen und Ihren Gästen an – vom ersten Beat bis zum letzten Tanz.
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 md:p-12 mb-10">
              ...
              <div className="space-y-6 text-lg md:text-xl text-white/80 mb-10 font-light">
                <p>
                  Wenn Sie denken: <span className="text-white font-medium italic">"Ja, genau so soll unsere Party klingen"</span> – perfekt.
                </p>
                <p>
